...
const (
	...
	CodeArchiveDBReadFailed          = "ARCHIVE_DB_READ_FAILED"
	CodeArchiveCacheResetFailed      = "ARCHIVE_CACHE_RESET_FAILED"
	CodeArchiveExperimentInvalid     = "ARCHIVE_EXPERIMENT_INVALID"
	CodeArchiveExperimentConflict    = "ARCHIVE_EXPERIMENT_CONFLICT"
	CodeArchiveExperimentUnavailable = "ARCHIVE_EXPERIMENT_UNAVAILABLE"
